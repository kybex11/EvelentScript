...
Most modern JavaScript features that EvelentScript supports can run natively in Node 7.6+, meaning that Node can run EvelentScript’s output without any further processing required. Here are some notable exceptions:

*  [JSX](#jsx) always requires transpilation.
*  [Splats, a.k.a. object rest/spread syntax, for objects](/#splats) are supported by Node 8.6+.
