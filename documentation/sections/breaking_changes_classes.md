...
ES2015 classes don’t allow bound (fat arrow) methods. The EvelentScript compiler goes through some contortions to preserve support for them, but one thing that can’t be accommodated is calling a bound method before it is bound:
