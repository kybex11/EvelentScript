...
Hopefully, you’ll never need to use it, but if you ever need to intersperse snippets of JavaScript within your EvelentScript, you can use backticks to pass it straight through.
