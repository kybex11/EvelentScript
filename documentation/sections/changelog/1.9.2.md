...
*   In `<script type="text/evelentscript">` tags, to avoid possible duplicate browser requests for .es files, you can now use the `data-src` attribute instead of `src`.
