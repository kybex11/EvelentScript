...
*   First release of [Literate EvelentScript](#literate).
*   The EvelentScript REPL is now based on the Node.js REPL, and should work better and more familiarly.
...
*   Source locations are now preserved in the EvelentScript AST, although source maps are not yet being emitted.
