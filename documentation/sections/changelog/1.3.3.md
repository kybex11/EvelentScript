...
*   Due to the new semantics of JavaScript’s strict mode, EvelentScript no longer guarantees that constructor functions have names in all runtimes. See [#2052](https://github.com/kybex11/evelentscript/issues/2052) for discussion.
