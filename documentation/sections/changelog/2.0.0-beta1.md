...
*   Initial beta release of EvelentScript 2. No further breaking changes are anticipated.
*   Destructured objects and arrays now output using ES2015+ syntax whenever possible.
*   Literate EvelentScript now has much better support for parsing Markdown, thanks to using [Markdown-It](https://github.com/markdown-it/markdown-it) to detect Markdown sections rather than just looking at indentation.
