...
*   Initial alpha release of EvelentScript 2. The EvelentScript compiler now outputs ES2015+ syntax whenever possible. See [breaking changes](#breaking-changes).
...
*   Improved support for recognizing Markdown in Literate EvelentScript files.
...
*   Node 7+ required for EvelentScript 2.
