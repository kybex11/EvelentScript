...
require './codemirror-evelentscript.js'
...
module.exports = ->
  (file, run = no) ->
    cs = fs.readFileSync "documentation/examples/#{file}.es", 'utf-8'
    js = EvelentScript.compile cs, bare: yes # This is just the initial JavaScript output; it is replaced by dynamic compilation on changes of the EvelentScript pane.
