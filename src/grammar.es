# The EvelentScript parser is generated by [Jison](https://github.com/zaach/jison)
...
grammar =
  ...
  # EvelentScript is the **Expression** -- everything that can be an expression
  ...
  Code: [
    o 'PARAM_START ParamList PARAM_END : TypeExpr FuncGlyph Block', -> new Code $2, $7, $6, LOC(1)(new Literal $1), $5
  ...
  CodeLine: [
    o 'PARAM_START ParamList PARAM_END : TypeExpr FuncGlyph Line', -> new Code $2, LOC(7)(Block.wrap [$7]), $6, LOC(1)(new Literal $1), $5
  ...
  # EvelentScript has two different symbols for functions. `->` is for ordinary
  ...
  Param: [
    ...
    o 'ParamVar : TypeExpr',                    -> new Param $1, null, null, $3
    o 'ParamVar ...',                           -> new Param $1, null, on
    o '... ParamVar',                           -> new Param $2, null, postfix: no
    o 'ParamVar = Expression',                  -> new Param $1, $3
    o 'ParamVar : TypeExpr = Expression',       -> new Param $1, $4, null, $3
    o '...',                                    -> new Expansion
  ]
  ...
  # In EvelentScript, an object literal is simply a list of assignments.
  Object: [
  ...
  InterfaceDecl: [
    o 'INTERFACE Identifier OptExtends INDENT InterfaceMembers OUTDENT', -> new InterfaceDeclaration $2, [], $3, $5
    o 'INTERFACE Identifier OptExtends TERMINATOR', -> new InterfaceDeclaration $2, [], $3, []
    o 'INTERFACE Identifier TYPE_ARG_START TypeParamList TYPE_ARG_END OptExtends INDENT InterfaceMembers OUTDENT', -> new InterfaceDeclaration $2, $4, $6, $8
    o 'INTERFACE Identifier TYPE_ARG_START TypeParamList TYPE_ARG_END OptExtends TERMINATOR', -> new InterfaceDeclaration $2, $4, $6, []
  ]

  TypeAliasDecl: [
    o 'TYPE Identifier = TypeExpr', -> new TypeAliasDeclaration $2, [], $4
    o 'TYPE Identifier TYPE_ARG_START TypeParamList TYPE_ARG_END = TypeExpr', -> new TypeAliasDeclaration $2, $4, $7
  ]

  TypeParamList: [
    o 'TypeParam', -> [$1]
    o 'TypeParamList , TypeParam', -> $1.concat $3
  ]

  TypeParam: [
    o 'Identifier', -> new TypeParameter $1
    o 'Identifier EXTENDS TypeExpr', -> new TypeParameter $1, $3
  ]

  OptExtends: [
    o '', -> null
    o 'EXTENDS TypeExpr', -> $2
  ]

  InterfaceMembers: [
    o 'InterfaceMember', -> [$1]
    o 'InterfaceMembers TERMINATOR InterfaceMember', -> $1.concat $3
  ]

  InterfaceMember: [
    o 'READONLY Property OptOptional : TypeExpr', -> new InterfaceMember $2, $5, {readonly: yes}
    o 'Property OptOptional : TypeExpr', -> new InterfaceMember $1, $4, {optional: $2}
    o 'READONLY Identifier OptOptional : TypeExpr', -> new InterfaceMember $2, $5, {readonly: yes}
    o 'Identifier OptOptional : TypeExpr', -> new InterfaceMember $1, $4, {optional: $2}
  ]
  ...
  TypeExpr: [
    o 'TypePrimary'
    o 'TypeExpr | TypeExpr', -> new UnionType $1, $3
    o 'TypeExpr & TypeExpr', -> new IntersectionType $1, $3
  ]

  TypePrimary: [
    o 'QualifiedName', -> new TypeReference $1, null
    o 'QualifiedName TYPE_ARG_START TypeList TYPE_ARG_END', -> new TypeReference $1, $3
    o 'STRING', -> new TypeReference $1
    o 'NUMBER', -> new TypeReference $1
    o 'NULL', -> new TypeReference 'null'
    o 'BOOL', -> new TypeReference $1
    o 'UNDEFINED', -> new TypeReference 'undefined'
    o 'PARAM_START ParamList PARAM_END : TypeExpr', -> new FunctionType $2, $5
    o 'TypePrimary INDEX_START INDEX_END', -> new ArrayType $1
    o 'READONLY TypePrimary', -> $2
    o 'TypePrimary ?', -> new OptionalType $1
  ]

  QualifiedName: [
    o 'Identifier', -> $1.value
    o 'QualifiedName . Identifier', -> "#{ $1 }.#{ $3.value }"
  ]

  TypeList: [
    o 'TypeExpr', -> [$1]
    o 'TypeList , TypeExpr', -> $1.concat $3
  ]
  ...
  Export: [
    ...
    o 'EXPORT InterfaceDecl',                                              -> new ExportNamedDeclaration $2
    o 'EXPORT TypeAliasDecl',                                              -> new ExportNamedDeclaration $2
  ...
  # The EvelentScript range literal.
  Range: [
  ...
  Operation: [
    ...
    # [The existential operator](/#existential-operator).
