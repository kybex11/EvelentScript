...
#
# The `es` command uses an instance of **OptionParser** to parse its
# command-line arguments in `src/command.es`.
exports.OptionParser = class OptionParser
  ...
  parse: (args) ->
    # The EvelentScript option parser is a little odd; options after the first
    ...
    # line `#!/usr/bin/env es`, or `#!/absolute/path/to/es`, without a
