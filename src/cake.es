...
# for EvelentScript. You define tasks with names and descriptions in a Cakefile,
...
exports.run = ->
  ...
  args = process.argv[2..]
  EvelentScript.run fs.readFileSync('Cakefile').toString(), filename: 'Cakefile'
