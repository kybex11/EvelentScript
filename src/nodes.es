# `nodes.es` contains all of the node classes for the syntax tree. Most
...
exports.Base = class Base
  ...
  # This is what `es --nodes` prints out.
  ...
  # error messages that come from `nodes.es` due to statements ending up
...
exports.Block = class Block extends Base
  ...
  compileComments: (fragments) ->
    for fragment, fragmentIndex in fragments
      ...
      if fragment.precedingComments
        ...
        # is the generated output JavaScript, and EvelentScript always
  ...
  astProperties: (o) ->
    ...
    return {
      ...
      # for EvelentScript to always know which it should be. The presence of an
      ...
      # then EvelentScript can copy Node’s algorithm.
...
# The EvelentScript class definition.
# Initialize a **Class** with its name, an optional superclass, and a body.

exports.Class = class Class extends Base
  children: ['variable', 'parent', 'body', 'typeParameters']

  constructor: (@variable, @parent, @body, @typeParameters) ->
    super()
    @typeParameters ?= []
    unless @body?
      @body = new Block
...
exports.Code = class Code extends Base
  constructor: (params, body, @funcGlyph, @paramStart, @returnType) ->
    super()
  ...
  # required per the ES2015 spec. If the EvelentScript function definition had
...
exports.Param = class Param extends Base
  constructor: (@name, @value, @splat, @typeAnnotation) ->
    super()
...
# A while loop, the only sort of low-level loop exposed by EvelentScript. From
...
exports.While = class While extends Base
  ...
  # The main difference from a JavaScript *while* is that the EvelentScript
...
# EvelentScript operations into their JavaScript equivalents.
exports.Op = class Op extends Base
  ...
  # The map of conversions from EvelentScript to JavaScript symbols.
  CONVERSIONS =
    '==':        '==='
    '!=':        '!=='
    'of':        'in'
...
# EvelentScript's replacement for the *for* loop is our array and object
...
exports.For = class For extends While
  ...
  # Welcome to the hairiest method in all of EvelentScript. Handles the inner
...
# Wherever in EvelentScript 1 we might’ve inserted a `makeCode "#{@tab}"` to
...
# Type system nodes (interfaces, type aliases, annotations).
extend exports, require './typesyntax'
