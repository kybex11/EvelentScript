...
(function() {
  var EvelentScript, addHistory, addMultilineHandler, fs, getCommandId, merge, nodeREPL, path, replDefaults, runInContext, sawSIGINT, transpile, updateSyntaxError, vm;
  ...
  replDefaults = {
    ...
    historyFile: (function() {
      ...
      if (historyPath) {
        return path.join(historyPath, '.es_history');
      }
    })(),
  ...
  module.exports = {
    start: function(opts = {}) {
      ...
      process.argv = ['es'].concat(process.argv.slice(2));
      if (opts.transpile) {
        transpile = {};
        try {
