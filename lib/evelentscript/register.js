...
(function() {
  var EvelentScript, Module, binary, cacheSourceMaps, child_process, ext, findExtension, fork, getRootModule, helpers, i, len, loadFile, nodeSourceMapsSupportEnabled, patchStackTrace, path, ref, ref1;
  ...
  if (require.extensions) {
    ref1 = EvelentScript.FILE_EXTENSIONS;
