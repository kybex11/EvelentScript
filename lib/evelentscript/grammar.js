...
(function() {
  ...
  grammar = {
    ...
    Expression: [o('Value'), o('Code'), o('Operation'), o('Assign'), o('If'), o('Try'), o('While'), o('For'), o('Switch'), o('Class'), o('InterfaceDecl'), o('TypeAliasDecl'), o('Throw'), o('Yield')],
    ...
    Code: [
      o('PARAM_START ParamList PARAM_END : TypeExpr FuncGlyph Block',
      function() {
        return new Code($2,
      $7,
      $6,
    ...
    CodeLine: [
      o('PARAM_START ParamList PARAM_END : TypeExpr FuncGlyph Line',
      function() {
        return new Code($2,
      LOC(7)(Block.wrap([$7])),
      $6,
    ...
    Param: [
      ...
      o('ParamVar : TypeExpr = Expression',
      function() {
        return new Param($1,
      $4,
      null,
    ...
    InterfaceDecl: [
      o('INTERFACE Identifier OptExtends INDENT InterfaceMembers OUTDENT',
      function() {
        return new InterfaceDeclaration($2,
      [],
      $3,
      $5);
      }),
      o('INTERFACE Identifier OptExtends TERMINATOR',
      function() {
        return new InterfaceDeclaration($2,
      [],
      $3,
      ...
      o('INTERFACE Identifier TYPE_ARG_START TypeParamList TYPE_ARG_END OptExtends INDENT InterfaceMembers OUTDENT',
      function() {
        return new InterfaceDeclaration($2,
      $4,
      $6,
      ...
      o('INTERFACE Identifier TYPE_ARG_START TypeParamList TYPE_ARG_END OptExtends TERMINATOR',
      function() {
        return new InterfaceDeclaration($2,
      $4,
      $6,
    ...
    TypeAliasDecl: [
      o('TYPE Identifier = TypeExpr',
      function() {
        return new TypeAliasDeclaration($2,
      [],
      $4);
      }),
      o('TYPE Identifier TYPE_ARG_START TypeParamList TYPE_ARG_END = TypeExpr',
      function() {
        return new TypeAliasDeclaration($2,
      $4,
      $7);
    ...
    TypeParam: [
      o('Identifier',
      function() {
        return new TypeParameter($1);
      }),
      o('Identifier EXTENDS TypeExpr',
      function() {
        return new TypeParameter($1,
      $3);
      })
    ...
    InterfaceMembers: [
      ...
      o('InterfaceMembers TERMINATOR InterfaceMember',
      function() {
        return $1.concat($3);
      })
    ],
    InterfaceMember: [
      o('READONLY Property OptOptional : TypeExpr',
      function() {
        return new InterfaceMember($2,
      $5,
      {
          readonly: true
        });
      }),
      o('Property OptOptional : TypeExpr',
      function() {
        return new InterfaceMember($1,
      $4,
      {
          optional: $2
        });
      }),
      o('READONLY Identifier OptOptional : TypeExpr',
      function() {
        return new InterfaceMember($2,
      $5,
      {
      ...
      o('Identifier OptOptional : TypeExpr',
      function() {
        return new InterfaceMember($1,
      $4,
      {
    ...
    TypeExpr: [
      ...
      o('TypeExpr | TypeExpr',
      function() {
        return new UnionType($1,
      $3);
      }),
      o('TypeExpr & TypeExpr',
      function() {
        return new IntersectionType($1,
      $3);
      })
    ],
    TypePrimary: [
      ...
      o('QualifiedName TYPE_ARG_START TypeList TYPE_ARG_END',
      function() {
        return new TypeReference($1,
      $3);
      }),
      ...
      o('UNDEFINED',
      function() {
        return new TypeReference('undefined');
      }),
      o('PARAM_START ParamList PARAM_END : TypeExpr',
      function() {
        return new FunctionType($2,
      $5);
      }),
      o('TypePrimary INDEX_START INDEX_END',
      function() {
        return new ArrayType($1);
      }),
      o('READONLY TypePrimary',
      function() {
        return $2;
      }),
      o('TypePrimary ?',
      function() {
        return new OptionalType($1);
      })
    ],
    QualifiedName: [
      o('Identifier',
    ...
    Export: [
      ...
      o('EXPORT InterfaceDecl',
      function() {
        return new ExportNamedDeclaration($2);
      }),
      o('EXPORT TypeAliasDecl',
      function() {
        return new ExportNamedDeclaration($2);
      }),
