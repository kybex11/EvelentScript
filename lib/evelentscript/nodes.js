  ...
  exports.Return = Return = (function() {
    class Return extends Base {
      constructor(expression1, {
          belongsToFuncDirectiveReturn: belongsToFuncDirectiveReturn1
        } = {}) {
        super();
        this.expression = expression1;
        this.belongsToFuncDirectiveReturn = belongsToFuncDirectiveReturn1;
      }
...
// multiline need to be indented.
  ...
  exports.Class = Class = (function() {
    class Class extends Base {
      constructor(variable1, parent1, body1, typeParameters) {
        super();
        this.variable = variable1;
        this.parent = parent1;
        this.body = body1;
    ...
    Class.prototype.children = ['variable', 'parent', 'body', 'typeParameters'];
  ...
  exports.Param = Param = (function() {
    class Param extends Base {
      constructor(name1, value1, splat1, typeAnnotation) {
        var message, token;
        super();
        this.name = name1;
        this.value = value1;
  ...
  exports.StringWithInterpolations = StringWithInterpolations = (function() {
    class StringWithInterpolations extends Base {
      constructor(body1, {
        ...
        this.jsxAttribute = jsxAttribute1;
      }
