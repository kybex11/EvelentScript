...
class EvelentLanguageService {
  ...
  updateDocument(esPath, source) {
    ...
    // Only surface raw syntax errors when the padded IntelliSense compile also
    // fails. Mid-edit incomplete source often fails the bare parser while the
    // padded path still works — those used to show as false red squiggles.
    if (compileError) {
